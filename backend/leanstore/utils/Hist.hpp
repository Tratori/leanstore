...
public:
	...
	Hist& operator=(Hist&) = delete;
        ...
        void print()
        {
           ...
           std::copy(histData.begin(), histData.end(), std::ostream_iterator<storageType>(std::cout, ","));
           std::cout << "]";
        }
	...
	void writePercentiles(std::ostream& out) {
           out << getPercentile(50) << "," << getPercentile(90) << "," << getPercentile(95) << "," << getPercentile(99) << "," << getPercentile(99.5)
               << "," << getPercentile(99.9) << "," << getPercentile(99.99);
        }
